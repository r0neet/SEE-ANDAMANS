...
const activitiesData = [
    {
        ...
        places: [
            { name: 'Havelock Island', subtitle: 'The Scuba Diving Capital', desc: "Home to world-class sites like Nemo Reef, Dixon's Pinnacle, and Jackson's Bar. Perfect for both beginners and pros.", img: 'https://res.cloudinary.com/dsrquoqqm/image/upload/f_auto,q_auto,w_1200/v1779139509/hero1_kvhccf.png' },
            { name: 'Neil Island', subtitle: 'Pristine & Quiet', desc: 'Known for being quieter and less explored, offering pristine untouched reefs and deeper, thrilling boat dive sites.', img: 'https://res.cloudinary.com/dsrquoqqm/image/upload/f_auto,q_auto,w_1200/v1779139515/hero3_ihu2dr.png' },
            { name: 'Port Blair', subtitle: 'Convenient & Accessible', desc: 'A great option for those with limited time in the islands, offering several nearby vibrant reef sites like North Bay.', img: 'https://res.cloudinary.com/dsrquoqqm/image/upload/f_auto,q_auto,w_1200/v1779139508/hero2_sdquhn.png' }
        ],
    ...
    },
    {
        ...
        places: [
            { name: 'North Bay Island', subtitle: 'The Pioneer Hub', desc: 'The most popular destination for Sea Walk in Port Blair, famous for its rich marine life near the coast.', img: 'https://res.cloudinary.com/dsrquoqqm/image/upload/f_auto,q_auto,w_1200/v1779139508/hero2_sdquhn.png' },
            { name: 'Havelock Island', subtitle: 'Elephant Beach', desc: 'A premium sea walking experience amidst the crystal clear waters of the famous Elephant Beach.', img: 'https://res.cloudinary.com/dsrquoqqm/image/upload/f_auto,q_auto,w_1200/v1779139509/hero1_kvhccf.png' },
            { name: 'Neil Island', subtitle: 'Quiet & Calm', desc: 'Experience the underwater walk in a more secluded environment with very calm currents.', img: 'https://res.cloudinary.com/dsrquoqqm/image/upload/f_auto,q_auto,w_1200/v1779139515/hero3_ihu2dr.png' }
        ],
    ...
    },
    {
        ...
        places: [
            { name: 'Elephant Beach', subtitle: 'Snorkeling Paradise', desc: 'Havelock’s primary hub for snorkeling. Shallow, clear waters teeming with colorful fish right off the beach.', img: 'https://res.cloudinary.com/dsrquoqqm/image/upload/f_auto,q_auto,w_1200/v1779139509/hero1_kvhccf.png' },
            { name: 'Jolly Buoy', subtitle: 'Protected Marine Area', desc: 'Part of the Mahatma Gandhi Marine National Park, offering the most vibrant and strictly protected corals.', img: 'https://res.cloudinary.com/dsrquoqqm/image/upload/f_auto,q_auto,w_1200/v1779139508/hero2_sdquhn.png' },
            { name: 'Bharatpur Beach', subtitle: 'Neil Island', desc: 'A gentle slope into the sea makes it highly accessible for families and elderly snorkelers.', img: 'https://res.cloudinary.com/dsrquoqqm/image/upload/f_auto,q_auto,w_1200/v1779139515/hero3_ihu2dr.png' }
        ],
    ...
    },
    {
        ...
        places: [
            { name: 'Water Sports Complex', subtitle: 'Port Blair', desc: 'The most accessible spot to hop on a Jet Ski and rip around the harbor area.', img: 'https://res.cloudinary.com/dsrquoqqm/image/upload/f_auto,q_auto,w_1200/v1779139508/hero2_sdquhn.png' },
            { name: 'Corbyn\'s Cove', subtitle: 'Scenic Coastline', desc: 'Ride the waves alongside a beautiful crescent-shaped, coconut palm-fringed beach.', img: 'https://res.cloudinary.com/dsrquoqqm/image/upload/f_auto,q_auto,w_1200/v1779139515/hero3_ihu2dr.png' },
            { name: 'Elephant Beach', subtitle: 'Havelock Action', desc: 'Combine your snorkeling trip with an adrenaline-pumping Jet Ski ride.', img: 'https://res.cloudinary.com/dsrquoqqm/image/upload/f_auto,q_auto,w_1200/v1779139509/hero1_kvhccf.png' }
        ],
    ...
    },
    {
        ...
        places: [
            { name: 'Corbyn\'s Cove', subtitle: 'Port Blair Aerials', desc: 'Launch from the beach or boat and see Port Blair coastline from a completely new angle.', img: 'https://res.cloudinary.com/dsrquoqqm/image/upload/f_auto,q_auto,w_1200/v1779139508/hero2_sdquhn.png' },
            { name: 'Elephant Beach', subtitle: 'Havelock Heights', desc: 'The absolute best place for parasailing, where you can literally see the reefs from the sky.', img: 'https://res.cloudinary.com/dsrquoqqm/image/upload/f_auto,q_auto,w_1200/v1779139509/hero1_kvhccf.png' },
            { name: 'North Bay', subtitle: 'Lighthouse Views', desc: 'Fly near the famous North Bay lighthouse, depicted on the 20-rupee note.', img: 'https://res.cloudinary.com/dsrquoqqm/image/upload/f_auto,q_auto,w_1200/v1779139515/hero3_ihu2dr.png' }
        ],
    ...
    },
    {
        ...
        places: [
            { name: 'Havelock Mangroves', subtitle: 'Night Kayaking', desc: 'Famous for bioluminescence tours where every paddle stroke lights up the water.', img: 'https://res.cloudinary.com/dsrquoqqm/image/upload/f_auto,q_auto,w_1200/v1779139509/hero1_kvhccf.png' },
            { name: 'Mayabunder', subtitle: 'Deep Forest Creeks', desc: 'Pristine, untouched mangrove forests offering long, undisturbed kayaking tracks.', img: 'https://res.cloudinary.com/dsrquoqqm/image/upload/f_auto,q_auto,w_1200/v1779139508/hero2_sdquhn.png' },
            { name: 'Baratang', subtitle: 'Limestone Passage', desc: 'Paddle through incredibly dense mangrove canopies en route to the famous limestone caves.', img: 'https://res.cloudinary.com/dsrquoqqm/image/upload/f_auto,q_auto,w_1200/v1779139515/hero3_ihu2dr.png' }
        ],
